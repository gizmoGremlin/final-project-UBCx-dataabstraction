...
public abstract class Shape {
    ...
    public Shape(Point topLeft, MidiSynth midiSynth) {
        ...
        /* instrument = 0;                                                               //initialize in rect */
        playLineCoord = 0;
    ...
    protected abstract void drawGraphics(Graphics g)   ;                               //{ g.drawRect(x, y, width, height);}

    //EFFECTS: fills the shape
    protected abstract void fillGraphics(Graphics g);       /* { g.fillRect(x, y, width, height); */
//    }
